...
<ol>
  ...
  <li>heatmaps_three_examples.R produces the heatmaps corresponding to the three representative examples of EDM analysis implemented with SHAP (Figure 7). pred_vs_obs_scatterplots.R plots the predicted versus observed MHCC. </li>
